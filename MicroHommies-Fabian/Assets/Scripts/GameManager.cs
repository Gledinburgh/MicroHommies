...
private void Start()
    ...
    public void StartMicrogame(string microgameSceneName)
    {
        ...
        selectedGameIndex = Array.IndexOf(microgameScenes, microgameSceneName);
    }
    ...
    public void EndMicrogame(int microgameScore)
    {
        ...
        {
            selectedGameIndex = Array.IndexOf(microgameScenes, currentSceneName);
            Debug.Log("current game: "+ selectedGameIndex + "   " + currentSceneName);
            SelectNextGame();
