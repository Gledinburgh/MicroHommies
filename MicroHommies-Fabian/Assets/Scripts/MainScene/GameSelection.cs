...
public class GameSelection : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.Return))
        {
            ...
            // find game the was chosen and setthe index of our array to that value 

          // Array.IndexOf(microgameScenes,microgameScenes[selectedGameIndex]);

           // currentGameNameIndex
        }
